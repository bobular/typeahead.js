describe("Remote", function () {
    beforeEach(function () {
        ...
        this.remote = new Remote({
            url: "/test?q=%QUERY", prepare: function (a) {
                return a
    ...
    describe("#get", function () {
        ...
        it("should transform request settings with prepare", function () {
            ...
            this.remote.get("foo", a);
            expect(this.transport.get).toHaveBeenCalledWith([{foo: "bar"}], jasmine.any(Function))
        });
        it("should transform response with transform", function () {
            var a;
            a = jasmine.createSpy();
            spyOn(this.remote, "transform").andReturn([{foo: "bar"}]);
            this.transport.get.andCallFake(function (c, b) {
                b(null, {})
            });
            this.remote.get("foo", a);
