describe("SearchIndex", function () {
    ...
    it("should support serialization/deserialization", function () {
        var b = this.index.serialize();
        this.index.bootstrap(b);
    ...
    it("#get should return datums by id", function () {
        ...
        this.index.add(fixtures.data.simple);
        expect(this.index.get(["big", "bigger"])).toEqual([{value: "big"}, {value: "bigger"}])
    });
    it("#search should return datums that match the given query", function () {
        expect(this.index.search("big")).toEqual([{value: "big"}, {value: "bigger"}, {value: "biggest"}]);
        expect(this.index.search("small")).toEqual([{value: "small"}, {value: "smaller"}, {value: "smallest"}])
    });
