...
(function (a, b) {
    ...
    var j = function () {
        return {
            isMsie: function () {
            ...
            }, isArray: d.isArray, isFunction: d.isFunction, isObject: d.isPlainObject, isUndefined: function (o) {
                ...
                return j.isUndefined(o) || o === null ? "" : o + ""
            }, bind: d.proxy, each: function (q, o) {
                d.each(q, p);
                function p(r, s) {
                    return o(s, r)
                }
            }, map: d.map, filter: d.grep, every: function (p, q) {
                var o = true;
                if (!p) {
                    return o
                }
                d.each(p, function (r, s) {
                    if (!(o = q.call(null, s, r, p))) {
                        return false
                    }
                });
                return !!o
                ...
                return !!o
            }, mixin: d.extend, identity: function (o) {
                return o
            }, clone: function (o) {
                return d.extend(true, {}, o)
            }, getIdGenerator: function () {
                var o = 0;
                return function () {
                    return o++
                }
            }, templatify: function m(p) {
                return d.isFunction(p) ? p : o;
                function o() {
                    return String(p)
                }
            }, defer: function (o) {
                ...
                return j.isString(o) ? o : JSON.stringify(o)
            }, noop: function () {
            }
        }
    }();
    var l = "0.11.1";
    var f = function () {
        return {nonword: m, whitespace: n, obj: {nonword: o(m), whitespace: o(n)}};
        function n(p) {
            p = j.toStr(p);
            return p ? p.split(/\s+/) : []
        }
        ...
        function o(q) {
            return function p(r) {
                r = j.isArray(r) ? r : [].slice.call(arguments, 0);
                return function s(u) {
                    var t = [];
                    j.each(r, function (v) {
                        t = t.concat(q(j.toStr(u[v])))
                    });
                    return t
                }
            }
    ...
    var k = function () {
        function n(u) {
            this.maxSize = j.isNumber(u) ? u : 100;
            this.reset();
            if (this.maxSize <= 0) {
        ...
        j.mixin(q.prototype, {
            add: function s(u) {
                ...
                u.prev ? u.prev.next = u.next : this.head = u.next;
                u.next ? u.next.prev = u.prev : this.tail = u.prev
            }, moveToFront: function (u) {
                this.remove(u);
                this.add(u)
            }
        });
    ...
    var h = function () {
        ...
        j.mixin(o.prototype, {
            _prefix: function (t) {
                ...
                this.get = this.set = this.remove = this.clear = this.isExpired = j.noop
            }, _safeSet: function (t, v) {
                try {
                    this.ls.setItem(t, v)
                } catch (u) {
                ...
                if (j.isNumber(t)) {
                    this._safeSet(this._ttlKey(u), p(n() + t))
                } else {
                    this.ls.removeItem(this._ttlKey(u))
                }
                ...
                var t, u = m(this.keyMatcher);
                for (t = u.length; t--;) {
                    this.remove(u[t])
                }
                return this
            }, isExpired: function (u) {
                var t = s(this.ls.getItem(this._ttlKey(u)));
        ...
        function p(t) {
            return JSON.stringify(j.isUndefined(t) ? null : t)
        }

        function s(t) {
            return d.parseJSON(t)
        }

        function m(u) {
            var w, v, x = [], t = r.length;
            for (w = 0; w < t; w++) {
                if ((v = r.key(w)).match(u)) {
                    x.push(v.replace(u, ""))
                }
            }
            return x
    ...
    var e = function () {
        ...
        t.setMaxPendingRequests = function n(u) {
            m = u
        };
        t.resetCache = function s() {
            q.reset()
        };
        j.mixin(t.prototype, {
            _fingerprint: function p(u) {
                u = u || {};
                return u.url + u.type + d.param(u.data || {})
            }, _get: function (B, v) {
                var A = this, y, z;
                y = this._fingerprint(B);
                if (this.cancelled || y !== this.lastReq) {
                    return
                }
                if (z = r[y]) {
                    z.done(x).fail(w)
    ...
    var a = window.SearchIndex = function () {
        var t = "c", u = "i";

        function m(z) {
            z = z || {};
            if (!z.datumTokenizer || !z.queryTokenizer) {
        ...
        j.mixin(m.prototype, {
            bootstrap: function o(z) {
                this.datums = z.datums;
                this.trie = z.trie
            }, add: function (A) {
                var z = this;
                A = j.isArray(A) ? A : [A];
                ...
                return A ? j.map(p(A), function (D) {
                    return z.datums[D]
                }) : []
            }, all: function w() {
                var z = [];
                for (var A in this.datums) {
                    z.push(this.datums[A])
                }
                return z
            }, reset: function s() {
                this.datums = {};
        ...
        return m;
        function q(z) {
            z = j.filter(z, function (A) {
                return !!A
            });
            z = j.map(z, function (A) {
    ...
    var b = function () {
        ...
        function r(y) {
            ...
            function u(A, z) {
                z.url = z.url.replace(t, encodeURIComponent(A));
                return z
            }
        ...
        function p(w) {
            ...
            v = w.rateLimitWait;
            if (!s) {
                s = /^throttle$/i.test(x) ? u(v) : t(v)
            }
            return s;
            function t(z) {
                return function y(A) {
                    return j.debounce(A, z)
                }
            }

            function u(z) {
                return function y(A) {
                    return j.throttle(A, z)
                }
            }
        }
    ...
    var i = function () {
        ...
        function s(z) {
            ...
            this.index = new a({
                ...
                datumTokenizer: z.datumTokenizer,
                queryTokenizer: z.queryTokenizer
            });
            z.initialize !== false && this.initialize()
        }

        s.noConflict = function r() {
            window && (window.Bloodhound = o);
            return s
        };
        s.tokenizers = f;
        j.mixin(s.prototype, {
            __ttAdapter: function t() {
                ...
                function A(E, D, C) {
                    return B.search(E, D, C)
                }

                function z(D, C) {
                    return B.search(D, C)
                }
            }, _loadPrefetch: function m() {
                var B = this, A, C;
                A = d.Deferred();
                if (!this.prefetch) {
                    A.resolve()
                } else {
                    if (C = this.prefetch.fromCache()) {
                        this.index.bootstrap(C);
                        A.resolve()
                    } else {
                        this.prefetch.fromNetwork(z)
                    }
                }
                return A.promise();
                function z(D, E) {
            ...
            }, initialize: function p(z) {
                return !this.initPromise || z ? this._initialize() : this.initPromise
            }, add: function x(z) {
                this.index.add(z);
                return this
            }, get: function n(z) {
                z = j.isArray(z) ? z : [].slice.call(arguments);
                return this.index.get(z)
            }, search: function y(D, C, A) {
                var B = this, z;
                z = this.sorter(this.index.search(D));
                C(this.remote ? z.slice() : z);
                if (this.remote && z.length < this.sufficient) {
                    this.remote.get(D, E)
                } else {
                    if (this.remote) {
                ...
                function E(G) {
                    ...
                    j.each(G, function (H) {
                        !j.some(z, function (I) {
                            return B.identify(H) === B.identify(I)
                        }) && F.push(H)
                    });
                    A && A(F)
                }
...
(function (a, b) {
    ...
    var i = function () {
        return {
            isMsie: function () {
            ...
            }, isArray: d.isArray, isFunction: d.isFunction, isObject: d.isPlainObject, isUndefined: function (n) {
            ...
            }, bind: d.proxy, each: function (p, n) {
                d.each(p, o);
                function o(q, r) {
                    return n(r, q)
                }
            }, map: d.map, filter: d.grep, every: function (o, p) {
                var n = true;
                if (!o) {
                    return n
                }
                ...
                return !!n
            }, mixin: d.extend, identity: function (n) {
                return n
            }, clone: function (n) {
    ...
    var j = function () {
        ...
        function n(s) {
            ...
            return {
                css: r.css, html: r.html, classes: r.classes, selectors: r.selectors, mixin: function (t) {
                    i.mixin(t, r)
                }
            }
        }
        ...
        function p(q) {
            return {wrapper: '<span class="' + q.wrapper + '"></span>', menu: '<div class="' + q.menu + '"></div>'}
        }
        ...
        function l() {
            ...
            if (i.isMsie()) {
                i.mixin(q.input, {backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"})
            }
            return q
        }
    }();
    ...
    var k = function () {
        ...
        function t(z, x, v, w) {
            ...
            while (y = x.shift()) {
                this._callbacks[y] = this._callbacks[y] || {sync: [], async: []};
    ...
    var b = function (o) {
        var n = {node: null, pattern: null, tagName: "strong", className: null, wordsOnly: false, caseSensitive: false};
        return function m(s) {
            var p;
            s = i.mixin({}, n, s);
            if (!s.node || !s.pattern) {
    ...
    var a = function () {
        ...
        H.extractData = function F(J) {
            var I = d(J);
            if (I.data(w.obj)) {
                return {val: I.data(w.val) || "", obj: I.data(w.obj) || null}
            }
            return null
        };
        i.mixin(H.prototype, k, {
            _overwrite: function m(J, I) {
                ...
                return i.isObject(J) ? i.mixin({_query: I}, J) : J
            }, update: function q(O) {
                var N = this, J = false, I = false, P = 0;
                this.cancel();
            ...
            }, cancel: d.noop, clear: function A() {
                this._empty();
                this.cancel();
